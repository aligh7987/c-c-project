...
#include "ui_ShowAllBooks.h"
#include <QFile>
#include <QTextStream>
#include <QMessageBox>
#include "Book.h"
#include "EditBook.h"
ShowAllBooks::ShowAllBooks(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ShowAllBooks)
{
    ui->setupUi(this);
//    this->showBooks();
}
...
void ShowAllBooks::on_back_clicked()
{
   this->hide();
}


void ShowAllBooks::on_delete_2_clicked()
{
...
void ShowAllBooks::on_edit_clicked()
{
    QList<QTableWidgetItem*> list = ui->tableBooks->selectedItems();
    if(!list.isEmpty()){
        QString id=list[0]->text();
